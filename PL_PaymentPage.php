                  ...
                  <div class="col-md-4" style="margin-left: 300px;">
                      <div class="form-group">
                          ...
                          <div class="input-group">
                              <input type="text" style="width: 360px;" name="accountId" placeholder="Card Number" required class="form-control"/>
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="input-group" style="width: 375px">
                              <input type="text" style="width: 80px; float: left;margin-right: 5px;" name="MM" placeholder="MM" required class="form-control"/>
                              <input type="text" style="width: 80px; float: left" name="YY" placeholder="YY" required class="form-control"/>
                              <div class="col-md-4" style="float: right;360px">
                                 <input type="text" style="width:40;" name="CVC" placeholder="CVC" required class="form-control"/>
                              </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="input-group">
                              <input type="text" style="width: 360px;" name="description" placeholder="Description" required class="form-control"/>
                          </div>
                      </div>
                      <button type="Reset" name="go" class="btn btn-md btn-primary " style="width: 360px">Pay</button>
                  </div>
              </form>   </div>
                    </div>
                  </div>
